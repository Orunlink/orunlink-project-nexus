      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <Link to="/signup" className="text-orunlink-purple hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="h-full flex items-center justify-center p-12">
          <div className="max-w-lg">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-white">
              <div className="text-2xl font-bold mb-4">Collaborate and Create</div>
              <p className="mb-6">
                Join thousands of creators, developers, and businesses on Orunlink. 
                Showcase your projects and connect with like-minded individuals.
              </p>
